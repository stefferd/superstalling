@if (Auth::check())
    <div class="navigation">
        <ul class="navigation-top" role="navigation">
            <li @if ($title == Lang::get('admin.dashboard'))class="active"@endif>
                <a href="{{ URL::route('admin.dashboard.index') }}">{{ Lang::get('admin.dashboard') }}</a>
            </li>
            <li @if ($title == Lang::get('users.menu'))class="active"@endif>
                <a href="{{ URL::route('admin.users.index') }}">{{ Lang::get('users.menu') }}</a>
            </li>
            <li @if ($title == Lang::get('pages.menu'))class="active"@endif>
            ...
            <li @if ($title == Lang::get('settings.menu'))class="active"@endif>
